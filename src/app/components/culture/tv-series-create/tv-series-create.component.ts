...
@Component({
  selector: 'app-tv-series-create',
  templateUrl: './tv-series-create.component.html',
  styleUrls: ['./tv-series-create.component.scss']
})
...
export class TvSerieCreateComponent implements OnInit {
  ...
  saveTvSerie(): void {
    ...
    this.tvSerie = {
      ...
      ended: this.addTvSerieForm.value.ended,
